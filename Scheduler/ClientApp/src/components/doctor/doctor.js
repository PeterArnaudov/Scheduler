...
const Doctor = ({ doctor: doctorObj, selectedAppointment, onSelectDoctor, onDelete, onSelectAppointment }) => {
    const navigate = useNavigate();

    const [doctor, setDoctor] = useState(doctorObj);
    ...
    const onDeleteClick = async (doctor) => {
